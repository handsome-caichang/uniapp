	...
	<view class="index-content">
				...
				<swiper class="swiper-container" :autoplay="true" :interval="3000" :circular="true" :indicator-dots="true"
				 indicator-active-color="#18C02C" indicator-color="#FFFFFF">
					<block v-for="(item, index) in bannerlist" :key="index">
						<swiper-item class="swiper-wrapper" @tap="previewImage(item.url)">
		...
		<view class="seckill-section m-t news">
			...
			<view class="product-list">
				<view class="uni-flex uni-row" v-for="(product, index) in productList" :key="index" @tap="tonot(product)" :class="{'border-bottom':index != productList.length-1 }">
					...
					<view class="uni-flex uni-column" style="flex: 1;padding-right:30upx">
						...
						<view class="text point" style="text-align: left;padding-left: 20upx;padding-top: 1urpx;text-overflow:ellipsis;overflow: hidden;"
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			// localStorage
			// userBindCid
			// 		03732f7a75c9ed61e50bec44a9b4453e
